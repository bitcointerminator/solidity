...
public:
	...
	MemberList(MemberList const& _other): m_memberTypes{_other.m_memberTypes} {}
	MemberList& operator=(MemberList const& _other)
	{
		m_memberTypes = _other.m_memberTypes;
		m_storageOffsets.reset(); // Let it be lazily recomputed.
		return *this;
	}
